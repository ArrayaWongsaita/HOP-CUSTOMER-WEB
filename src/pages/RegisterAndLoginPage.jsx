...
export default function RegisterAndLoginPage() {
  ...
  useEffect(() => {
    if (getAccessToken()) {
      navigate("/"); // เปลี่ยนเส้นทางไปหน้า Homepage
    }
  }, [navigate]);
  ...
  return (
    <div className="h-[100vh] w-[430px] bg-black">
      ...
      <div className="w-[90%] mx-auto relative z-40 ">
        ...
        {toggle ? (
          <div
            className="rounded-b-2xl rounded-tr-2xl mx-auto h-[500px] flex items-center relative z-40
          ...
          <div
            className="rounded-b-2xl rounded-tl-2xl mx-auto h-[500px] flex items-center relative z-40
